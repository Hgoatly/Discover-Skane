    ...
    var lakeMap = new google.maps.Map(document.getElementById("lake-map"), {
     ...
     var forestsMap = new google.maps.Map(document.getElementById("forests-map"), {
      ...
      var locations = [
          ...
          //Beach coordinates
          {lat: 55.6850, lng: 14.2266, info: "<div class='info-header'>Kivik</div>"},
          {lat: 55.6420, lng: 14.2616, info: "<div class='info-header'>Knäbäckshusen</div>"},
          {lat: 55.8812, lng: 14.2282, info: "<div class='info-header'>Yngsjö</div>"},
          {lat: 55.3971, lng: 12.8415, info: "<div class='info-header'>Falsterbo</div>"},
          {lat: 56.2234, lng: 12.7103, info: "<div class='info-header'>Farhultsbaden</div>"},
          {lat: 55.6782, lng: 13.0588, info: "<div class='info-header'>Lomma Norra Badplats</div>"},
          {lat: 55.3385, lng: 13.3598, info: "<div class='info-header'>Smygehuk</div>"},
          {lat: 55.3867, lng: 14.1932, info: "<div class='info-header'>Sandhammaren</div>"},
          {lat: 55.4250, lng: 13.8491, info: "<div class='info-header'>Ystad Havsbad</div>"},
          //Malmo coordinates
          {lat: 55.6050, lng: 13.0038, info: "<div class='info-header'>Malmö</div>"},
          {lat: 55.5964, lng: 12.9963, info: "<div class='info-header'>Malmö Opera</div>"},
          {lat:55.6077, lng: 12.9936, info: "<div class='info-header'>Malmö Concert House</div>"},
          {lat: 55.6048, lng: 12.9876, info: "<div class='info-header'>Malmö Castle</div>"},
          {lat: 55.6074489, lng: 13.0075645, info: "<div class='info-header'>Disgusting Food Museum</div>"},
          //Helsingborg coordinates
          {lat: 56.0465, lng: 12.6945, info: "<div class='info-header'>Helsingborg</div>"},
          {lat: 56.0478, lng: 12.6891, info: "<div class='info-header'>Dunkers Culture House</div>"},
          {lat: 56.0498, lng: 12.6893, info: "<div class='info-header'>Helsingborg Concert House</div>"},
          {lat: 56.0839, lng: 12.6596, info: "<div class='info-header'>Sofiero Castle</div>"},
          //Lund coordinates
          {lat: 55.70587, lng: 13.1932, info: "<div class='info-header'>Lund</div>"},
          {lat: 55.7041, lng: 13.1937, info: "<div class='info-header'>Lutheren Cathedral</div>"},
          {lat: 55.7046, lng: 13.1965, info: "<div class='info-header'>Kulturen</div>"},
          {lat: 55.6996, lng: 13.1879, info: "<div class='info-header'>Lund Planetarium</div>"}
        ];
