...
function initAutocomplete() {
  ...
  var locations = [
    ...
    },
    {
      ...
      lng: 14.1932,
      infoEng:
        "<h3 class='info-header'>Sandhammaren</h3><p>The silky white sands of Sandhammaren match the best beaches of the Caribbean. It’s been voted as Sweden’s best beach several times. Slouch around on white, powdery sand, take a dip in the sea, or enjoy a beach walk that goes for miles.</p><p>Attribution: <a class='info-header' href='https://visitskane.com/outdoors-adventure/sandhammaren-beach' target='_blank'>Visit Skåne</a></p>",
      infSwe:
    ...
    },
    {
      ...
      infoSwe: 
        "<h3 class='info-header'>Kulturen</h3><p>Kulturen i Lund är ett museum som sträcker sig över två kvarter i centrala Lund, fyllda med kulturhistoriska hus och trädgårdsmiljöer som du kan besöka. Stig in i husen och upplev livet i staden och på landet, från medeltiden och fram till 1930-talet.</p><p>Attribution: <a class='info-header' href='https://www.kulturen.com/vara-besoksmal/' target='_blank'>Kulturen</a></p>",
       type: museumsIcon,
    },
    {
      lat: 55.6996,
